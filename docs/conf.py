...
# -*- coding: utf-8 -*-
#
# pgwall_test documentation build configuration file, created by
...
init_file = os.path.join('..', 'pgwall_test', '__init__.py')
...
htmlhelp_basename = 'pgwall_testdoc'
...
latex_documents = [
    (master_doc, 'pgwall_test.tex',
     u'pgwall_test Documentation',
     u'Patrick Wall', 'manual'),
]
